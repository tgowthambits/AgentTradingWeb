"""
Django settings for Trading Platform project.
"""
...
if os.environ.get("USE_IN_MEMORY_CHANNEL", "False").lower() == "true":
    CHANNEL_LAYERS = {
        "default": {
...
# Trading System Configuration Path
TRADING_SYSTEM_PATH = BASE_DIR.parent / "trading_system"
